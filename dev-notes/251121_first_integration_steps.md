...
* Use the kdupro project as an example for the data format recorded. More columns will be added for the combined sensors of the two projects. Data saved should be in csv format.
